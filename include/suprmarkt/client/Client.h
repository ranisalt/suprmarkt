...
public:
	 ...
	 *
	 * A melhor fila que o Client pode escolher depende de sua estratégia de escolha de fila. A fila então escolhida receberá o Client pelo método enqueue, modificará o tempo de saída do Client e o inserirá na fila.
	 *
	 * @param queues
	 */
